...
<body>
    ...
    <div class="contenu">
        <div class="intro">
            <h2 class="duel-gras">DUEL</h2>
            <img src="Images/Duel.png" alt="duel" class="duel-img">
            <div class="texte">
                <p>Affrontez votre ami dans un duel acharné de questions sur l’informatique.</p>
                <p>Tout comme le mode solo, des questions seront posées aux joueurs.</p>
                <p>Le premier à répondre correctement gagne le point.</p>
                <p>Montrez à vos amis que vous êtes le meilleur !</p>
            </div>
        </div>
