...
if (isset($_POST['reset'])) {
    ...
    $_SESSION[$rep_key] = 0;
    header("Location: quizz_moyen_10q.php");
    exit;
}
...
if ($_SESSION[$rep_key] >= $MAX_QUESTIONS) {
    ...
    $sql_question = "SELECT id, enonce FROM questions WHERE niveau='moyen' ORDER BY RAND() LIMIT 1";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['reponse'])) {
        ...
        if ($result_verif && $result_verif->num_rows > 0) {
            ...
            $_SESSION[$rep_key] += 1;
            header("Location: quizz_moyen_10q.php"); // éviter resoumission
            exit;
        }
...
<head>
    <meta charset="UTF-8">
    <title>Quiz - Moyen</title>
    <link rel="stylesheet" href="Quizz.css">
</head>
<body>
    <div class="header">
        <a href="Acceuil.php" class="btn-retour">← Accueil</a>
        <h1 class="titre-centre">Quiz - Niveau Moyen</h1>
    </div>
